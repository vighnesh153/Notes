...
//    ),
  ...
  Future<void> fetchAndSetProducts() async {
    var url = URL + DB_NAME + '.json?auth=$authToken';
    try {
      ...
      url = URL + URL_SEGMENT + '$userId.json?auth=$authToken';
  ...
  Future<void> addProduct(Product product) async {
    final url = URL + DB_NAME + '.json?auth=$authToken';
  ...
  Future<void> updateProduct(String id, Product product) async {
    final url = URL + DB_NAME + '/$id.json?auth=$authToken';
